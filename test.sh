...
docker build -t fastapi-py310-async-mem-leak-test py3.9-async >/dev/null 2>&1
echo "Start Server...."
...
echo "=========================================="
docker stats fastapi-py38-async fastapi-py39-async fastapi-py310-async --no-stream --format "{{.Name}}: {{.MemUsage}}"
echo "=========================================="
...
echo "=========================================="
echo "Cleanup...."
docker stop fastapi-py38-async fastapi-py39-async fastapi-py310-async >/dev/null 2>&1
docker rm fastapi-py38-async fastapi-py39-async fastapi-py310-async >/dev/null 2>&1